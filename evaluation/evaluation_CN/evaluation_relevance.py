...
# Go up 2 levels from evaluation_CN to reach project root
PROJECT_ROOT = Path(__file__).resolve().parents[2]
INFERENCE_DIR = PROJECT_ROOT / "inference"

# Add both to sys.path so Python can find modules
...
# That navigates up from evaluation_CN → evaluation → Multi3Hate

CSV_PATH = BASE_DIR / "inference" / "llm_responses.csv"
PLOTS_DIR = BASE_DIR / "evaluation" / "relevance"
JSON_DIR = BASE_DIR / "evaluation" / "relevance_json"
