...
# ─── 1. Setup import path to your inference modules ───────────────────────────────
HERE        = Path(__file__).parent          # .../Multi3Hate/evaluation
PROJECT     = HERE.parent                    # .../Multi3Hate
INFER_DIR   = PROJECT / "inference"
...
INDIAN_SYSTEM   = [{"text":
    "You are an Indian internet user familiar with regional culture, politics, pop-culture, and internet slang. "
    "Look at the following meme (image and caption). Answer with exactly one word—either “Hate” or “Non-Hate”—"
    "based on whether this meme is offensive or hateful in the Indian cultural context."
}]
...
# ─── 8. Main entrypoint ───────────────────────────────────────────────────────────
def main():
    captions = load_captions(PROJECT / "data" / "captions" / "en.csv")
    images   = pick_one_per_group(PROJECT / "data" / "memes", "en")
    ...
    out = HERE / "evaluation_IN" / "results" / "baseline_vs_cultural.csv"
